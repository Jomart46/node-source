...
<div class="button-container">
        <button style="background: linear-gradient(40deg, #647685, #65cc60); border: none; border-radius: 5px; margin-top:50px;">
...
<thead>
    <tr>
        ...
        <th style="width: 15%;">Fertilizer</th>
...
<tbody>
    <?php foreach ($products as $row) : ?>
        <tr class="record">
            ...
            <td><?php echo $row['fertilizer_type']; ?></td>
