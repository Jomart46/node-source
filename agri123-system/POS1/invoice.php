...
<html lang="en">
       ...
       #printPage {
        ...
        #printPageButton {
          background: linear-gradient(40deg, #647685, #65cc60) !important;
            /* Set the gradient to start with green (#4CAF50) and transition to gray (#808080) */
            color: white;
            /* Set the text color to white for better contrast */
            padding: 10px 20px;
            /* Adjust the padding as needed to fit your button content */
            border: none;
        ...
        #printPageButton:hover {
            background: linear-gradient(to right, #4CAF50, #4CAF50 50%, #808080 50%);
            /* Apply the same gradient on hover to maintain the effect */
        }

        /* Optionally, you can add more styles to the icon if needed */
        #printPageButton .fas {
            margin-right: 5px;
   ...
   <body class="fixed-nav sticky-footer" id="page-top">
    ...
    <!-- Navigation-->
    <nav class="navbar navbar-expand-lg navbar-dark" id="mainNav" style="background: linear-gradient(40deg, #647685, #65cc60) !important;">
    <a class="navbar-brand" href="index.php">Agri-product Report</a>
...
<div class="card-body">
    <div style="display: flex; align-items: center;">
        <strong>Agricultural Product Report</strong>
    </div>
</div> 

<div style="text-align: center;">
<img src="./logo1.png" alt="logo" style="height: 100px; width: 100px; margin-left: 10px;">
<img src="./logo2.png" alt="logo" style="height: 100px; width: 100px; margin-left: 10px;"><br>
<strong>Pangasinan State University</strong>
    <div>San Carlos City Campus</div>
    <div>Roxas Blvd, San Carlos City</div>
    <div>Pangasinan</div>
    <strong>Agricultural Product Report</strong>
</div>
...
<?php
 ...
 $sql = "SELECT * from buyers WHERE Cust_id='$cust_id'";
